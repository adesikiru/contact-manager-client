...
const Contacts = () => {
  ...
  const deleteContact = (id) => {
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://contact-manager-server-three.vercel.app/api/contactmsyt/contact/${id}`, {
            headers: {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("https://contact-manager-server-three.vercel.app/api/contactmsyt/contacts", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
